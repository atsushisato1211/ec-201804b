...
<tr>
<td>
<span class="form-group has-float-label"><form:input path="email" class="form-control" placeholder="例：rakus@rakus.co.jp"/>
...
<tr>
<td>
<span class="form-group has-float-label"><form:password path="password" class="form-control" placeholder="8文字以上16文字以内"/>
...
<tr>
<td>
<span class="form-group has-float-label"><form:password path="confirmationpassword" class="form-control" placeholder="8文字以上16文字以内"/>
